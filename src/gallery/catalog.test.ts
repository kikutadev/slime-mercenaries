...
const EXPECTED_MOTIONS: Readonly<Record<string, readonly string[]>> = {
  ...
  blademaster: ['idle', 'move', 'attack', 'defeat'],
  berserker: ['idle', 'move', 'attack', 'defeat'],
  paladin: ['idle', 'move', 'attack', 'defeat'],
  fortress: ['idle', 'move', 'attack', 'defeat'],
  sniper: ['idle', 'move', 'attack', 'defeat'],
  'storm-archer': ['idle', 'move', 'attack', 'defeat'],
  archmage: ['idle', 'move', 'attack', 'defeat'],
  'frost-mage': ['idle', 'move', 'attack', 'defeat'],
  ninja: ['idle', 'move', 'attack', 'defeat'],
  assassin: ['idle', 'move', 'attack', 'defeat'],
  cannoneer: ['idle', 'move', 'attack', 'defeat'],
  engineer: ['idle', 'move', 'attack', 'defeat'],
  ...
  'ember-gecko': ['idle', 'move', 'attack', 'hit', 'defeat'],
  'charcoal-roller': ['idle', 'move', 'attack', 'hit', 'defeat'],
