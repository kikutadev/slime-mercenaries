...
import { getMimicMotionProfile } from './enemy-motion/mimic';
...
export * from './enemy-motion/mimic';
...
export function getEnemyMotionProfile(behaviorId: EnemyBehaviorId | string): EnemyMotionProfile {
  ...
  if (behaviorId === 'mimic-chest-snap') return getMimicMotionProfile(behaviorId);
