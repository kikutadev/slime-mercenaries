...
Combat role: control / slow

## 1. Design intent

This file defines the content-specific model and motion direction for **Frost Mage Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Pale crystal crown and frost mist; cyan/navy branch variant.
...
Slower breathing with condensation drifting near ground.

### Move / bounce

Soft sliding bounce with reduced rebound.

### Basic attack

Ice bolt applies visible slow/frost marker.

### Skill / signature behavior

Plant wand, compress, expand circular freeze field; affected targets frost over.
...
Freeze field must communicate radius/duration without hiding enemies.
