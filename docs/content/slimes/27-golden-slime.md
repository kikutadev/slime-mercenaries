...
Combat role: economy / support

## 1. Design intent

This file defines the content-specific model and motion direction for **Golden Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Metallic honey-gold translucent jelly with moving specular flow and coin sparkles.
...
Surface highlight visibly migrates as body breathes.

### Move / bounce

Cheerful bounce with tiny coin-like sparkles.

### Basic attack

Small coin/jelly projectile or body bump.

### Skill / signature behavior

Reward/economy trigger creates rapid happy wobble and compact coin burst.
...
Must look like golden jelly, not a rigid gold statue.
