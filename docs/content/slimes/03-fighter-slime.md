...
Classification: Sword / Tier 2  
Combat role: melee bruiser

## 1. Design intent

This file defines the content-specific model and motion direction for **Fighter Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Headband plus broader sword; stable, confident silhouette with minimal armor.
...
Firmer breathing and ready lean; headband tails follow jelly with delay.

### Move / bounce

Confident short hops with less side wobble than Sword.

### Basic attack

Two-hit combo: forward slash, then body-assisted return cut; second impact is stronger.

### Skill / signature behavior

Primary identity is the connected 2-hit rhythm rather than a large standalone skill.
...
Do not drift toward a humanoid swordsman; slime body remains primary.
