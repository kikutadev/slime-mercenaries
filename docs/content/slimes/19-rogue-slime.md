...
Classification: Dagger / Tier 2  
Combat role: mobile DPS

## 1. Design intent

This file defines the content-specific model and motion direction for **Rogue Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Dark hood, twin daggers, compact asymmetry.
...
Irregular side lean with delayed hood motion.

### Move / bounce

Lateral zig-zag bounces.

### Basic attack

Two alternating dagger hits with body crossing left/right.

### Skill / signature behavior

Sidestep threatening attack, then re-enter from side/back for bonus hit.
...
Mobility comes from jelly translation, not humanoid footwork.
