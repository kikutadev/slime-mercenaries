...
Classification: Shield / Tier 1  
Combat role: defender

## 1. Design intent

This file defines the content-specific model and motion direction for **Shield Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Round shield almost body-sized, cream/gold accent; face stays visible beside or above shield.
...
Shield gently rocks while jelly peeks around it.

### Move / bounce

Low protected bounce while keeping shield toward threat.

### Basic attack

Short shield bash/body-check with compact forward compression.

### Skill / signature behavior

Quick lateral body-block hop to interpose for an ally.
...
First Shield form establishes protection without turning into full armor.
