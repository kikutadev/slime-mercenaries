...
Classification: Dagger / Tier 1  
Combat role: skirmisher

## 1. Design intent

This file defines the content-specific model and motion direction for **Dagger Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Tiny hood and one readable dagger, dark-indigo accent.
...
Fast micro-wobbles; eyes feel more alert.

### Move / bounce

Very quick short bounces.

### Basic attack

Rapid hop-in stab followed by elastic hop-back to home position.

### Skill / signature behavior

No separate baseline skill; speed and recovery are the identity.
...
Repeated attacks must not drift the stable combat anchor.
