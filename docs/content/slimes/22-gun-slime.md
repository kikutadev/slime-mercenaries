...
Classification: Gun / Tier 1  
Combat role: ranged rapid

## 1. Design intent

This file defines the content-specific model and motion direction for **Gun Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Comically large flintlock, amber/steel accent; barrel alignment is obvious.
...
Weapon weight tilts body; muzzle slowly drifts.

### Move / bounce

Small bounce with gun lag.

### Basic attack

Single pistol shot; body compresses backward from recoil; compact muzzle smoke.

### Skill / signature behavior

No separate baseline skill; recoil is the visual identity.
...
Muzzle alignment and recoil direction are acceptance-critical.
