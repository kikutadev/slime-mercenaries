...
Combat role: elite bruiser

## 1. Design intent

This file defines the content-specific model and motion direction for **Dragon Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Tiny horns, winglets and jelly-integrated tail; slime first, dragon cues second.
...
Faint breath glow builds inside translucent body; winglets twitch.

### Move / bounce

Powerful low bounce; winglets stabilize rather than fly.

### Basic attack

Short jelly-bite/body-lunge using temporary face/body stretch.

### Skill / signature behavior

Lean back, cheeks/core swell with light, release bounded cone breath.
...
Do not turn into a baby-dragon mesh; round cute slime identity is mandatory.
