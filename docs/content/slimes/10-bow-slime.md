...
Classification: Bow / Tier 1  
Combat role: safe physical ranged

## 1. Design intent

This file defines the content-specific model and motion direction for **Bow Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Sideways readable bow arc, leaf-green accent, face unobstructed.
...
Body subtly stretches backward as if maintaining bow tension.

### Move / bounce

Light hops with bow lag.

### Basic attack

Draw compresses/back-stretches body; release snaps forward; one clear arrow projectile.

### Skill / signature behavior

No separate baseline skill; projectile readability is the identity.
...
Existing `archer-slime.glb`; preserve current ranged anchor behavior.
