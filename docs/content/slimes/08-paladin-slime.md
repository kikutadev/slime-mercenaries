...
Classification: Shield / Tier 3  
Combat role: sustain tank / barrier support

## 1. Design intent

This file defines the content-specific model and motion direction for **Paladin Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

White-gold shield and small halo/crest; sacred accents remain restrained.
...
Slightly buoyant idle; halo/crest floats with delayed follow.

### Move / bounce

Soft confident bounce with shield leading.

### Basic attack

Shield-edge strike followed by a tiny light burst.

### Skill / signature behavior

Barrier pulse wraps nearby allies in a thin readable shell.
...
Support effect must visibly connect this slime to protected allies.
