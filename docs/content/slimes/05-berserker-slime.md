...
Classification: Sword / Tier 3  
Combat role: burst melee

## 1. Design intent

This file defines the content-specific model and motion direction for **Berserker Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Chipped heavy greatsword, wild brow/scarf accent; still round and cute.
...
Breathing and jelly tremor accelerate as HP falls.

### Move / bounce

Heavy hop with aggressive forward lean.

### Basic attack

Large anticipation into a very fast heavy chop/sweep; impact is violent, recovery short.

### Skill / signature behavior

Low-HP frenzy increases cadence and may add a second follow-through.
...
Weight comes from anticipation and impact, not a sluggish release.
