...
Classification: Bow / Tier 2  
Combat role: mobile ranged

## 1. Design intent

This file defines the content-specific model and motion direction for **Ranger Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Green hood and recurved bow; lightweight outdoors silhouette.
...
Hood edge and bow string imply constant readiness.

### Move / bounce

Small lateral step-bounces between shots.

### Basic attack

Quick double shot: first release tilts one way, second recovers through opposite lean.

### Skill / signature behavior

Short evasive sidestep can precede double shot when threatened.
...
Do not implement as Bow animation merely replayed twice; connect both shots through body rhythm.
