...
Combat role: team aura

## 1. Design intent

This file defines the content-specific model and motion direction for **King Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Crown motif, royal particles, richer jelly finish; never distinguished mainly by scale.
...
Slow commanding bounce; crown follows with delayed regal weight.

### Move / bounce

Deliberate low-frequency bounce.

### Basic attack

Compact royal body slam or scepter-like jelly gesture.

### Skill / signature behavior

Crown flare sends aura pulse to allies; allies visibly answer with short buff reaction.
...
Mutation must be screenshot-readable at the same broad body scale as normal slimes.
