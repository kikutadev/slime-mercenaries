...
Combat role: boss killer / pierce

## 1. Design intent

This file defines the content-specific model and motion direction for **Sniper Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Enormous longbow plus small sight motif; narrow, clean silhouette.
...
Almost motionless during aim; eyes/body narrow toward target.

### Move / bounce

Measured low hops, then a full stop before firing.

### Basic attack

Long readable aim followed by extremely fast piercing arrow and large recoil.

### Skill / signature behavior

Charged line shot pierces aligned enemies.
...
Contrast comes from stillness-before-release; aim period stays visually clean.
