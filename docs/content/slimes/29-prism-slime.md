...
Combat role: elemental burst

## 1. Design intent

This file defines the content-specific model and motion direction for **Prism Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Transparent body, shifting internal spectral bands, crystalline edge motifs.
...
Internal color bands move independently through jelly.

### Move / bounce

Clean floating-like bounces with refracted contact spark.

### Basic attack

Elemental projectile changes shape by active element, not color alone.

### Skill / signature behavior

Collect light inward, briefly clarify body, emit prism beam splitting into bounded directions.
...
Keep refraction readable on mobile and prevent transparent-body disappearance on bright backgrounds.
