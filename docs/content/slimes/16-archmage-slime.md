...
Classification: Wand / Tier 3  
Combat role: burst AoE

## 1. Design intent

This file defines the content-specific model and motion direction for **Archmage Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Tall star hat, orbiting motes, strong rune silhouette but unchanged body size.
...
Multiple motes orbit at different phases while body remains calm.

### Move / bounce

Brief levitation pulses between grounded bounces.

### Basic attack

Rune-enhanced orb with compact splash.

### Skill / signature behavior

Deep squash, vertical stretch, telegraphed large rune, then meteor/rune burst.
...
Major cast needs readable anticipation and bounded area; avoid screen washout.
