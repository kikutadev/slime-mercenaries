...
Classification: Shield / Tier 2  
Combat role: tank

## 1. Design intent

This file defines the content-specific model and motion direction for **Guardian Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Tower shield plus small helm; broad vertical defensive silhouette.
...
Planted breathing; shield stays unusually stable.

### Move / bounce

Short low hops with minimal airborne time.

### Basic attack

Shield bash with visible knockback impulse.

### Skill / signature behavior

Plant, compress, emit bounded guard pulse protecting nearby allies.
...
Guard pulse should be a clear ring, not generic full-screen glow.
