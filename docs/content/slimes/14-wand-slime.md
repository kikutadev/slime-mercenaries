...
Classification: Wand / Tier 1  
Combat role: basic magic ranged

## 1. Design intent

This file defines the content-specific model and motion direction for **Wand Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Crooked wand and tiny cap, violet/blue accent; whimsical and non-humanoid.
...
Wand drifts as if slightly self-propelled around the jelly beat.

### Move / bounce

Soft float-like bounce while still contacting ground.

### Basic attack

Compress backward, flick wand, launch one small magic orb.

### Skill / signature behavior

No separate baseline skill; casting pulse establishes magic cadence.
...
Casting must feel unlike Bow: gesture/pulse first, projectile second.
