...
Combat role: explosive AoE

## 1. Design intent

This file defines the content-specific model and motion direction for **Cannoneer Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Cannon behind/alongside normal-size body; strong barrel silhouette.
...
Leans into cannon; barrel settles slowly.

### Move / bounce

Pushes cannon with heavy low bounces.

### Basic attack

Arcing shell with clear launch and travel.

### Skill / signature behavior

Press into cannon, fire with explosive recoil, shell lands in bounded AoE.
...
Arc trajectory and impact radius must both be visible in gallery.
