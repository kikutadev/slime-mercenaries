...
Classification: Gun / Tier 3  
Combat role: utility DPS / summon

## 1. Design intent

This file defines the content-specific model and motion direction for **Engineer Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Goggles, wrench, compact mini-turret parts; avoid visual clutter.
...
Checks/wobbles wrench while turret part subtly ticks.
...
Small tool-shot/projectile when turret is unavailable.

### Skill / signature behavior

Drop/spit turret parts, rapidly assemble with jelly-assisted motion, deploy temporary attacking turret.
...
Core identity is adding a temporary battlefield object; its full lifecycle must be gallery-testable.
