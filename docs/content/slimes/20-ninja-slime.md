...
Combat role: mobile multi-hit

## 1. Design intent

This file defines the content-specific model and motion direction for **Ninja Slime**. Product-level rules in `docs/specs/art-direction.md`, `docs/specs/combat.md`, and `docs/specs/evolution-roster.md` remain authoritative.

## 2. Model / silhouette

Scarf tails, forehead plate, restrained shuriken motifs.
...
Periodically sinks very low; scarf remains visible during anticipation.

### Move / bounce

Low extremely quick bounds.

### Basic attack

Midrange shuriken flick with tiny recoil.

### Skill / signature behavior

Squash near-flat, pop vanish, afterimage dash through enemies, reappear and resolve multiple hits.
...
Vanishing must retain a readable origin and return point; never source-less damage.
